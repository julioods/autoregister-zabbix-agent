...
schtasks /create /tn "url-teste" /tr "powershell.exe -ExecutionPolicy Bypass -File C:\Zabbix\monitor_script.ps1" /sc minute /mo 5 /ru SYSTEM

if %errorlevel% equ 0 (
    echo Tarefa "url-teste" criada com sucesso.
) else (
